...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_Crc = CLK_GATE_DEFINE(AHB_CLK_CTRL0, 27), /*!< Clock gate name: Crc. */
...
#define CM_SCGRCCRSCSCLKSEL 0x3FE
...
typedef enum _clock_attach_id
{
    ...
    kTRO_to_MAIN_CLK      = MUX_A(CM_SCGRCCRSCSCLKSEL, 8),  /*!< Attach tro to MAIN_CLK. */
    ...
    kCLK1M_to_SYSTICK0        = MUX_A(CM_SYSTICKCLKSEL0, 1), /*!< Attach Clk 1 MHz to SYSTICK0. */
    ...
    kCLK1M_to_SYSTICK1        = MUX_A(CM_SYSTICKCLKSEL1, 1), /*!< Attach Clk 1 MHz to SYSTICK1. */
    ...
    kCLK1M_to_TRACE     = MUX_A(CM_TRACECLKSEL, 1), /*!< Attach Clk 1 MHz to TRACE. */
    ...
    kFRO1M_to_CTIMER0        = MUX_A(CM_CTIMERCLKSEL0, 0),  /*!< Attach FRO_1M to CTIMER0. */
    ...
    kFRO1M_to_CTIMER1        = MUX_A(CM_CTIMERCLKSEL1, 0),  /*!< Attach FRO_1M to CTIMER1. */
    ...
    kFRO1M_to_CTIMER2        = MUX_A(CM_CTIMERCLKSEL2, 0),  /*!< Attach FRO_1M to CTIMER2. */
    ...
    kFRO1M_to_CTIMER3        = MUX_A(CM_CTIMERCLKSEL3, 0),  /*!< Attach FRO_1M to CTIMER3. */
    ...
    kFRO1M_to_CTIMER4        = MUX_A(CM_CTIMERCLKSEL4, 0),  /*!< Attach FRO_1M to CTIMER4. */
    ...
    kPLL1_CLK0_to_ADC1 = MUX_A(CM_ADC1CLKSEL, 4), /*!< Attach PLL1_clk0 to ADC1. */
    kUSB_PLL_to_ADC1   = MUX_A(CM_ADC1CLKSEL, 5), /*!< Attach USB PLL to ADC1. */
    ...
    kFRO1M_to_I3C0FCLKSTC    = MUX_A(CM_I3C0FCLKSTCSEL, 1), /*!< Attach FRO_1M to I3C0FCLKSTC. */
    kNONE_to_I3C0FCLKSTC     = MUX_A(CM_I3C0FCLKSTCSEL, 7), /*!< Attach NONE to I3C0FCLKSTC. */

    kFRO1M_to_I3C0FCLKS = MUX_A(CM_I3C0FCLKSSEL, 0), /*!< Attach FRO_1M to I3C0FCLKS. */
    ...
    kFRO48M_to_ESPI    = MUX_A(CM_ESPICLKSEL, 3), /*!< Attach FRO_48M to ESPI. */
    ...
    kNONE_to_ENETRMII      = MUX_A(CM_ENETRMIICLKSEL, 7), /*!< Attach NONE to ENETRMII. */
    ...
    kFRO16K2_to_WDT1    = MUX_A(CM_WDT1CLKSEL, 0), /*!< Attach FRO16K clock 2 to WDT1. */
    ...
    kFRO1M_to_I3C1FCLKSTC    = MUX_A(CM_I3C1FCLKSTCSEL, 1), /*!< Attach FRO_1M to I3C1FCLKSTC. */
    kNONE_to_I3C1FCLKSTC     = MUX_A(CM_I3C1FCLKSTCSEL, 7), /*!< Attach NONE to I3C1FCLKSTC. */

    kFRO1M_to_I3C1FCLKS = MUX_A(CM_I3C1FCLKSSEL, 0), /*!< Attach FRO_1M to I3C1FCLKS. */
 ...
 *  @return Frequency of ESPI Clock
 */
