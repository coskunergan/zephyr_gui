...
enum _lpuart_interrupt_enable
{
    ...
    kLPUART_AllInterruptEnable = kLPUART_CtsStateChangeInterruptEnable | kLPUART_DsrStateChangeInterruptEnable |
                                 ...
                                 kLPUART_TxDataRegEmptyInterruptEnable | kLPUART_ParityErrorInterruptEnable |
                                 kLPUART_FramingErrorInterruptEnable | kLPUART_NoiseErrorInterruptEnable |
...
enum _lpuart_flags
{
...
#endif
    kLPUART_CtsStateChangeInterruptFlag    = LPUART_MCR_CTS_MASK << 2U, /*!< Change of state on CTS_B pin. bit 2 */
    kLPUART_DsrStateChangeInterruptFlag    = LPUART_MCR_DSR_MASK << 2U, /*!< Change of state on DSR_B pin. bit 3 */
    kLPUART_RinStateChangeInterruptFlag    = LPUART_MCR_RIN_MASK << 2U, /*!< Change of state on RIN_B pin. bit 4 */
    kLPUART_DcdStateChangeInterruptFlag    = LPUART_MCR_DCD_MASK << 2U, /*!< Change of state on DCD_B pin. bit 5 */
    kLPUART_RxCounter0TimeoutInterruptFlag = 1UL << 10,                 /*!< Receiver counter0 timeout. bit 10 */
    kLPUART_RxCounter1TimeoutInterruptFlag = 1UL << 11,                 /*!< Receiver counter1 timeout. bit 11 */
    kLPUART_TxCounter0TimeoutInterruptFlag = 1UL << 12,                 /*!< Transmitter counter0 timeout. bit 12 */
    kLPUART_TxCounter1TimeoutInterruptFlag = 1UL << 13,                 /*!< Transmitter counter1 timeout. bit 13 */
#if defined(FSL_FEATURE_LPUART_HAS_ADDRESS_MATCHING) && FSL_FEATURE_LPUART_HAS_ADDRESS_MATCHING
    kLPUART_DataMatch2InterruptFlag =
        LPUART_STAT_MA2F_MASK, /*!< The next character to be read from LPUART_DATA matches MA2. bit 14 */
    kLPUART_DataMatch1InterruptFlag =
        LPUART_STAT_MA1F_MASK, /*!< The next character to be read from LPUART_DATA matches MA1. bit 15 */
#endif
    kLPUART_ParityErrorInterruptFlag =
        (LPUART_STAT_PF_MASK), /*!< If parity enabled, sets upon parity error detection. bit 16 */
    kLPUART_FramingErrorInterruptFlag =
        (LPUART_STAT_FE_MASK), /*!< Frame error flag, sets if logic 0 was detected where stop bit expected. bit 17 */
    kLPUART_NoiseErrorInterruptFlag = (LPUART_STAT_NF_MASK), /*!< Receive takes 3 samples of each received bit.  If any
                                                       of these samples differ, noise flag sets. bit 18 */
    kLPUART_RxOverrunInterruptFlag = (LPUART_STAT_OR_MASK),  /*!< Receive Overrun, sets when new data is received before
                                                       data is  read from receive register. bit 19 */
    kLPUART_IdleLineInterruptFlag =
        (LPUART_STAT_IDLE_MASK), /*!< Idle line detect flag, sets when idle line detected. bit 20 */
    kLPUART_RxDataRegFullInterruptFlag = (LPUART_STAT_RDRF_MASK), /*!< Receive data register full flag, sets when the
                                                            receive data buffer is full. bit 21 */
    kLPUART_TransmissionCompleteInterruptFlag =
        (LPUART_STAT_TC_MASK), /*!< Transmission complete flag, sets when transmission activity complete. bit 22 */
    kLPUART_TxDataRegEmptyInterruptFlag =
    ...
    kLPUART_RxActiveEdgeInterruptFlag = (LPUART_STAT_RXEDGIF_MASK), /*!< Receive pin active edge interrupt flag, sets
                                                              when active edge detected. bit 30 */
#if defined(FSL_FEATURE_LPUART_HAS_LIN_BREAK_DETECT) && FSL_FEATURE_LPUART_HAS_LIN_BREAK_DETECT
    kLPUART_LinBreakInterruptFlag = (LPUART_STAT_LBKDIF_MASK), /*!< LIN break detect interrupt flag, sets when LIN break
                                                         char detected and LIN circuit enabled. bit 31 */
#endif

    kLPUART_AllClearFlags = kLPUART_CtsStateChangeInterruptFlag | kLPUART_DsrStateChangeInterruptFlag |
                            kLPUART_RinStateChangeInterruptFlag | kLPUART_DcdStateChangeInterruptFlag |
                            kLPUART_ParityErrorInterruptFlag | kLPUART_FramingErrorInterruptFlag |
                            kLPUART_NoiseErrorInterruptFlag | kLPUART_RxOverrunInterruptFlag |
                            kLPUART_IdleLineInterruptFlag | kLPUART_RxActiveEdgeInterruptFlag
#if defined(FSL_FEATURE_LPUART_HAS_FIFO) && FSL_FEATURE_LPUART_HAS_FIFO
                            | kLPUART_TxFifoOverflowInterruptFlag | kLPUART_RxFifoUnderflowInterruptFlag
#endif
#if defined(FSL_FEATURE_LPUART_HAS_ADDRESS_MATCHING) && FSL_FEATURE_LPUART_HAS_ADDRESS_MATCHING
                            | kLPUART_DataMatch2InterruptFlag | kLPUART_DataMatch1InterruptFlag
#endif
#if defined(FSL_FEATURE_LPUART_HAS_LIN_BREAK_DETECT) && FSL_FEATURE_LPUART_HAS_LIN_BREAK_DETECT
                            | kLPUART_LinBreakInterruptFlag
#endif
    ,

    kLPUART_AllFlags =
        kLPUART_CtsStateChangeInterruptFlag | kLPUART_DsrStateChangeInterruptFlag |
        kLPUART_RinStateChangeInterruptFlag | kLPUART_DcdStateChangeInterruptFlag | kLPUART_ParityErrorInterruptFlag |
        kLPUART_FramingErrorInterruptFlag | kLPUART_NoiseErrorInterruptFlag | kLPUART_RxOverrunInterruptFlag |
        kLPUART_IdleLineInterruptFlag | kLPUART_RxDataRegFullInterruptFlag | kLPUART_TransmissionCompleteInterruptFlag |
        kLPUART_TxDataRegEmptyInterruptFlag | kLPUART_RxActiveFlag | kLPUART_RxActiveEdgeInterruptFlag
#if defined(FSL_FEATURE_LPUART_HAS_FIFO) && FSL_FEATURE_LPUART_HAS_FIFO
        | kLPUART_TxFifoOverflowInterruptFlag | kLPUART_RxFifoUnderflowInterruptFlag | kLPUART_TxFifoEmptyFlag |
        kLPUART_RxFifoEmptyFlag
#endif
#if defined(FSL_FEATURE_LPUART_HAS_ADDRESS_MATCHING) && FSL_FEATURE_LPUART_HAS_ADDRESS_MATCHING
        | kLPUART_DataMatch2InterruptFlag | kLPUART_DataMatch1InterruptFlag
...
typedef void (*lpuart_irq_handler_t)(LPUART_Type *base, void *handle);
